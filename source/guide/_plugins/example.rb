# Copy of
# https://raw.githubusercontent.com/twbs/bootstrap/v4-dev/_plugins/example.rb
...
eos
      ...
      def example(output)
        "<div class=\"strib-guide-example\" data-example-id=\"#{@options[:id]}\">\n#{output}\n</div>"
      end
      ...
      def render_rouge(code)
        ...
        "<div class=\"strib-guide-highlight\"><pre>#{code}</pre></div>"
      end
